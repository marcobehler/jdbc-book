...
public class ApplicationV22Solved {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try (connection) {
            ...
            try (connection2) {
                ...
                try (PreparedStatement stmt2 = connection2.prepareStatement(
                    ...
                    stmt2.setInt(3, senderVersion);
                    final int rowsUpdated = stmt2.executeUpdate();
